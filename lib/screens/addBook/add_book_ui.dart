        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              CommonButton.icon(onTap: addBookProvider.handleDeleteBook, child: Icon(Icons.delete,color: context.colorScheme.onBackground,))
            ],
          ),
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _ChooseBookWidget(),
                const Gap(5),
                Selector<AddBookProvider, bool>(selector: (context, addBookProvider) => addBookProvider.showBookRequiredMsg,
                  builder: (context, showBookRequiredMsg, child) {
                    if(showBookRequiredMsg){

                    return Text(AppStrings.fileIsRequired,style: context.textTheme.labelMedium?.copyWith(color: context.colorScheme.error,));
                  }else{
          ...
          bottomNavigationBar: Padding(
            ...
            child: ButtonItem.filled(
                ...
                onTap:addBookProvider.handleUpload, text: AppStrings.uploadBook),
          ),
        ),
      ),
    );
          ...
          builder: (context, bookFile, child) {
              if(bookFile == null){
                ...
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(bookFile.path,style: context.textTheme.labelSmall,),
                    const Gap(10),
                    Row(
                      children: [
                        Expanded(
                          child: ButtonItem.outline(
                              ...
                              onTap: addBookProvider.viewFile, text: 'View',height: 45,fontSize: 16),
                        ),
