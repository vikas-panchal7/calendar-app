...
fontFamily: "Inter",
  ...
  textTheme: const TextTheme(
    labelSmall:
        TextStyle(fontSize: 11, fontFamily: "Inter", color: Colors.black),
    labelMedium:
        TextStyle(fontSize: 12, fontFamily: "Inter", color: Colors.black),
    bodySmall:
        TextStyle(fontSize: 12, fontFamily: "Inter", color: Colors.black),
    bodyMedium:
    ...
    titleMedium:
        TextStyle(fontSize: 18, fontFamily: "Inter", color: Colors.black),
    labelLarge:
        TextStyle(fontSize: 20, fontFamily: "Inter", color: Colors.black),
    titleLarge:
        TextStyle(fontSize: 22, fontFamily: "Inter", color: Colors.black),
    displaySmall:
        TextStyle(fontSize: 24, fontFamily: "Inter", color: Colors.black),
    displayMedium:
        TextStyle(fontSize: 26, fontFamily: "Inter", color: Colors.black),
    displayLarge:
        TextStyle(fontSize: 28, fontFamily: "Inter", color: Colors.black),
    headlineSmall:
        TextStyle(fontSize: 30, fontFamily: "Inter", color: Colors.black),
    headlineMedium:
        TextStyle(fontSize: 32, fontFamily: "Inter", color: Colors.black),
    headlineLarge:
        TextStyle(fontSize: 34, fontFamily: "Inter", color: Colors.black),
  ),
);
